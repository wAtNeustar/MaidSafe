...
set(CPACK_PACKAGE_DESCRIPTION_SUMMARY " CloudEncryptor")
if(NOT APPLE)
  # set(CPACK_RESOURCE_FILE_README "${lifestuff_ui_qt_SOURCE_DIR}/installer/text/lifestuff/readme.txt")
  set(CPACK_RESOURCE_FILE_LICENSE "${drive_SOURCE_DIR}/src/maidsafe/drive/installer/text/eula.txt")
endif()
...
elseif(WIN32)
  set(CPACK_PACKAGE_NAME "CloudEncryptor")
  ...
  install(FILES ${PACKAGE_BINARY_DIR}/drive_demo.exe DESTINATION .)
  install(FILES ${PACKAGE_BINARY_DIR}/cbfs_driver.exe DESTINATION .)
  install(FILES ${drive_SOURCE_DIR}/src/maidsafe/drive/installer/driver/cbfs.cab DESTINATION driver)
  if(CMAKE_CL_64)
    install(FILES ${drive_SOURCE_DIR}/src/maidsafe/drive/installer/driver/64bit/x64/cbfsinst.dll DESTINATION driver)
  else()
    install(FILES ${drive_SOURCE_DIR}/src/maidsafe/drive/installer/driver/32bit/cbfsinst.dll DESTINATION driver)
  endif()
  install(FILES ${drive_SOURCE_DIR}/src/maidsafe/drive/installer/text/eula.txt DESTINATION .)
  ...
  set(CPACK_PACKAGE_INSTALL_DIRECTORY "Maidsafe\\\\CloudEncryptor")
  set(CPACK_GENERATOR NSIS)
  set(CPACK_PACKAGE_INSTALL_REGISTRY_KEY "CloudEncryptor")
  set(CPACK_NSIS_EXTRA_INSTALL_COMMANDS "")
  set(CPACK_NSIS_EXTRA_UNINSTALL_COMMANDS "")
  set(CPACK_NSIS_MODIFY_PATH ON)
  set(CPACK_NSIS_DISPLAY_NAME "CloudEncryptor")
  set(CPACK_NSIS_PACKAGE_NAME "CloudEncryptor")
  set(CPACK_NSIS_INSTALLED_ICON_NAME "drive_demo.exe")
  set(CPACK_NSIS_EXECUTABLES_DIRECTORY ".")
  set(CPACK_NSIS_HELP_LINK "http://www.maidsafe.net")
  set(CPACK_NSIS_URL_INFO_ABOUT "http://maidsafe.net/lifestuff.html")  # Needs a URL
  set(CPACK_NSIS_CONTACT "support@maidsafe.net")
  set(CPACK_PACKAGE_RELOCATABLE ON)
  set(CPACK_NSIS_MENU_LINKS "http://maidsafe.net/lifestuff.html" "About CloudEncryptor")  # Needs a URL
  set(CPACK_PACKAGE_FILE_NAME "${CPACK_NSIS_DISPLAY_NAME}_${CPACK_PACKAGE_VERSION}_${TargetPlatform}_${TargetArchitecture}")
endif()
set(CPACK_STRIP_FILES ON)
set(CPACK_PACKAGE_CONTACT "support@maidsafe.net")
set(CPACK_PACKAGE_EXECUTABLES "CloudEncryptor" "CloudEncryptor")
